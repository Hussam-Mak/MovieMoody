# gemini_api.py - Google Gemini API using REST
...
def get_movie_recommendation(feeling):
    ...
    ✨ IMPORTANT: Only respond with the movie title on the FIRST line. Do not include any explanation, description, or follow-up questions. Return ONLY the movie title.
